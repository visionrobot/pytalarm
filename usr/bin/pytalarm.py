...
class PytAlarm(Gtk.Application):
	...
	def draw_gtk_addalarm(self, window):
		...
		hboxS.pack_start(self.entryScript, False, True, self.DEF_PAD)
...
class Application(Gtk.ApplicationWindow):
	...
	def __init__(self):
		...
		if sys.platform == "win32":
			...
			self.sIcon = sRootDir + self.sIcon
			self.sActiveIcon = sRootDir + self.sActiveIcon
...
if __name__ == "__main__":
	...
	if os.path.isfile(app.pidfile):
		print("\033[93m%s already exists\033[0m" % app.pidfile)
